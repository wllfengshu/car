...
@Slf4j
@Api(value = "tbCar Rest",tags = "tbCar管理")
@RestController
@RequiredArgsConstructor
@RequestMapping("/tbCars")
public class TbCarRest {
    ...
    @RequestMapping(value = "/tbCar", method = RequestMethod.POST)
    public Map<String, Object> insert(
            @RequestHeader(value = "sessionId") String sessionId,
            HttpServletRequest request,
            HttpServletResponse response,
            @RequestBody TbCarEntity entity) throws CustomException {
        log.info("insert entity:{}", entity);
        return tbCarService.insert(entity, sessionId);
    }
    ...
    @RequestMapping(value = "/tbCar/{id}", method = RequestMethod.DELETE)
    public Map<String, Object> delete(
        ...
        return tbCarService.delete(id, sessionId);
    }
    ...
    @RequestMapping(value = "/tbCar", method = RequestMethod.PUT)
    public Map<String, Object> update(
        ...
        return tbCarService.update(entity, sessionId);
    }
    ...
    @RequestMapping(value = "/tbCar/{id}", method = RequestMethod.GET)
    public Map<String, Object> select(
        ...
        return tbCarService.select(id, sessionId);
    }
    ...
    public Map<String, Object> selects(
        ...
        return tbCarService.selects(params, pageNo, pageSize, sessionId);
    }
}
